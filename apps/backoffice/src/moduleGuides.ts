...
const dashboardGuide: ModuleGuideDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      kind: "section",
      audience: "Boss/Admin",
      purpose: "Work through overdue, due-today, and due-soon operational reminders alongside department actions.",
      actions: ["Process overdue items first.", "Process due-today items next.", "Review Daily Spend items due soon and department actions.", "Use Open action to enter the owning workflow.", "Use All reminders to review the complete reminder inbox."],
...
const vehicleGuide: ModuleGuideDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      kind: "section",
      audience: "Sales",
      purpose: "Capture real acquisition cost, internal adjusted cost, selling price, and pickup information.",
      actions: ["Enter the real purchase price and, when needed, an internal modified purchase price used for margin and profit.", "Review contra, additional payment, refurbishment, commission, and outstation allowance.", "Add pickup date and reference when applicable."],
...
const deliveryGuide: ModuleGuideDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      actions: ["Open Details for the correct plate.", "Verify buyer, PIC, schedule, address, and transport.", "Maintain inspection booking/report, insurance and road tax references and expiry dates.", "Record reschedule or rework reason when relevant.", "Save the updated record."],
    ...
    },
    {
      ...
      actions: ["Complete inspection and its report reference.", "Confirm documents prepared, polish, tint, and wash.", "Confirm insurance and road tax coverage with current expiry dates.", "Send the 2-day notice and customer notification.", "Confirm handover photo, signed handover, customer acknowledgement, and final checklist.", "Mark Ready, then Release with confirmation."],
      requiredItems: ["Inspection and report", "Documents prepared", "Polish, tint, and wash", "Insurance and road tax handled with current expiry", "2-day notice", "All five release documents", "Handover/customer/final confirmations"],
