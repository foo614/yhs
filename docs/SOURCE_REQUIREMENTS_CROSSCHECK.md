...
| Insurance, road tax, windscreen insurance | Implemented | The Clear documents stage requires delivery-bound `Policy`, `RoadTaxReceipt`, and `WindscreenPolicy` evidence, valid expiry dates, and read-only Finance clearance before handover. |
