...
- HR payslips can be downloaded as an audited one-page PDF summary; the endpoint applies the same self-service versus HR/Admin ownership boundary and does not invent statutory deductions or identity numbers that are not stored in payroll data.
