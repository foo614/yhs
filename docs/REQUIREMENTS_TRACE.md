...
| Leads triage | Implemented; focused verification pending | Public enquiries appear in back office, lead/customer linking, status/customer-link filters, duplicate phone reuse, Sales-agent attribution, and a server-scoped Cars I’m Handling view with monthly sold and current-process counts. |
